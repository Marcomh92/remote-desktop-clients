...
| Element | Role |
|---|---|
| `ModifierRowView` | Horizontally-scrollable row of 8 keys in order: `[Win, Shift, Ctrl, Alt, Del, Esc, Tab, 123]`. Row height `40dp` (round 4; was 48 dp), per-button width `dp(56)` (round 4; was 72 dp); `makeButton:190-204` zeroes `minHeight`/`minimumHeight` for parity with `ExtraKeysView`. See `bVNC/src/main/java/com/iiordanov/bVNC/extrakeys/ModifierRowView.java:61-363`. |
...
17. `bVNC/src/main/java/com/iiordanov/bVNC/RemoteCanvasActivity.java` — `setInputAreaState:1612-1628`, `updateRdpInputAreaVisibility:1681-1689`, `onKeyboardToggleButtonClicked:1699-1712`, `setInputHandler:1350-1356` (RDP handler attach), `keyboardToggleButton` inline drag-vs-tap listener `:1048-1103`, RDP-only IME insets listener on `canvasLayout` at `:315-339`, `recomputeRdpViewport:1641-1672` (single RDP viewport owner — round 3), `getTouchpadSensitivityMultiplier:1282-1286` (round 3 coefficient `0.6f`), RDP-gated legacy shrink block at `relayoutViews:514-517`, end-of-relayout RDP recompute at `:609-615`, `onBackPressed:1734-1752`, `setModes` touchpad fallback at `:866-867`. **Round-4:** `onCreate:307` pushes `setEdgeThresholdDp`; `onResume:906-913` re-pushes all three tunables; `getInputHandlerById:1232-1268` (esp. `:1240` `setAccelerationStrength`, `:1261-1263` `setFlingDamp`); prefs `getEdgeThresholdDpPref:1304-1306`, `getMouseAccelerationStrength:1308-1311`, `getFlingResistanceDamp:1313-1316`.
18. `bVNC/src/main/java/com/iiordanov/bVNC/RemoteCanvas.java:823-832`, `:738-744`, `:733-735`, **`rdpFullViewHeight` field `:109`, accessors `:876-882` (round 3)**, **`edgeThreshDp` field `:71` + `EDGE_THRESH_DP` constant `:70` + `setEdgeThresholdDp:915-917` + consumption in `movePanToMakePointerVisible:525-600` (round 4)**
